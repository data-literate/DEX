...
class WeatherPipelineDeployer:
    ...
    def __init__(self, config_path: str | None = None):
        if config_path is None:
            config_path = str(Path(__file__).parent / "config" / "job_config.json")
    ...
    def deploy_notebooks(self) -> bool:
        ...
        notebooks = [
            (
                str(base_path / "notebooks/extract_weather.py"),
                "/Shared/weather/extract_weather",
            ),
            (
                str(base_path / "notebooks/load_weather.py"),
                "/Shared/weather/load_weather",
            ),
        ]
