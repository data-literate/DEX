...
- **Docs/tests**: `tests/test_main.py` and `tests/test_metrics.py` cover the environment-sensitive metrics, and the documentation now explains how to validate the new alerts.
